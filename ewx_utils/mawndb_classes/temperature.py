...
"""
class temperature:
    valid_hourly_atmp = { "jan":(-39,25), "feb":(-39,24), "mar": (-38,33), "apr": (-29,36), "may":(-13,40), "jun":(-8,44), "jul": (-5,46),
                          "aug": (-6,44), "sep": (-13, 43), "oct": (-18,37), "nov": (-33,33), "dec": (-39,25) }
    ...
    def IsValid(self):
        ...
        if self.record_date is not None:
            ...
            return atmp_valid_range[0] <= self.tempC and self.tempC <= atmp_valid_range[1]
