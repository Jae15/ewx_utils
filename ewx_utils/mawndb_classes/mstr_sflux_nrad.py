...
class soilmoisture:
    ...
    def IsValid(self):
        if (
            self.mstr > self.valid_mstr_hourly_default[0]
            and self.mstr < self.valid_mstr_hourly_default[1]
        ):
            return True
        else:
            return False
...
class soilheatflux:
    ...
    def IsValid(self):
        if (
            self.sflux > self.valid_sflux_hourly_default[0]
            and self.sflux < self.valid_sflux_hourly_default[1]
        ):
            return True
        else:
            return False
...
class netradiation:
    ...
    def IsValid(self):
        if (
            self.nrad > self.valid_nrad_hourly_default[0]
            and self.nrad < self.valid_nrad_hourly_default[1]
        ):
            return True
        else:
            return False
